...
export const RELEASE_LOG: readonly Release[] = [
  {
    ...
    entries: {
      [ReleaseCategory.NEW]: [
        'Page Contact : posez une question, proposez une amélioration ou signalez un problème, avec ou sans compte, depuis le site comme depuis votre espace.',
        'Si vous êtes connecté, votre adresse email est déjà renseignée et vous pouvez joindre la session concernée à un signalement.',
        'Un accusé de réception vous est envoyé par email, et les informations techniques ne sont jointes qu’avec votre accord.',
      ],
    },
  },
  {
    ...
    entries: {
      [ReleaseCategory.NEW]: [
        'Cinq épreuves du secteur ferroviaire : Logique, Mémoire, Discrimination visuelle, Réactivité et Motricité, cette dernière jouable avec votre téléphone en guise de manette.',
        'En Logique, choisissez les familles d’exercices à travailler et entraînez-vous, si vous le souhaitez, sans chronomètre.',
        ...
        'Correction consultable après chaque épreuve, et page Progression avec votre meilleur score et vos courbes d’évolution.',
        ...
        'Fil des obtentions sur l’accueil : votre prénom n’y apparaît que si vous l’activez depuis votre profil.',
      ...
      [ReleaseCategory.CONTENT]: [
        'Guide des épreuves et guide de Logique : chaque exercice expliqué avant de vous lancer.',
      ],
    },
  },
];
