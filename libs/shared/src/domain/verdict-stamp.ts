...
const SIMULATION_STAMP_EXCELLENT_MARGIN = 25;
const SIMULATION_STAMP_SOLID_MARGIN = 15;
const SIMULATION_STAMP_COMFORTABLE_MARGIN = 5;
const SIMULATION_STAMP_INSUFFICIENT_GAP = 5;
