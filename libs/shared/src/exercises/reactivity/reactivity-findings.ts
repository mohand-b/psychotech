...
const REACTIVITY_POST_ERROR_WINDOW = 3;
const REACTIVITY_POST_ERROR_SLOWDOWN_RATIO = 1.15;
const REACTIVITY_POST_ERROR_MIN_SAMPLES = 2;
const REACTIVITY_FATIGUE_RISE_RATIO = 1.15;
const REACTIVITY_FATIGUE_MIN_TREND_POINTS = 6;
const REACTIVITY_LATE_WRONG_CONCENTRATION_RATIO = 0.5;
const REACTIVITY_ANTICIPATIONS_MIN = 2;
const REACTIVITY_RELATIVE_SD_THRESHOLD = 0.3;
const REACTIVITY_PHASE_STEP_MS = 60;
const REACTIVITY_PHASE_STEP_MIN_VALID = 2;
