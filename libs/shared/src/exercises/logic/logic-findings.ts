...
const LOGIC_FAMILY_MIN_ERRORS = 2;
const LOGIC_FAMILY_CONCENTRATION_RATIO = 0.5;
const LOGIC_IMPULSIVE_TIME_RATIO = 0.5;
const LOGIC_IMPULSIVE_MIN_COUNT = 2;
const LOGIC_SLOW_PRECISION_MIN = 85;
const LOGIC_END_QUARTER_RATIO = 0.75;
const LOGIC_END_CONCENTRATION_RATIO = 0.5;
const LOGIC_END_MIN_MISSES = 3;
const LOGIC_SKIPPED_MIN = 2;
const LOGIC_FAMILY_GAP_MIN_PCT = 25;
...
const LOGIC_TRIANGLE_INVERSED_LEVEL = 4;
const LOGIC_TRIANGLE_WRONG_RATE_MIN = 0.5;
const LOGIC_TRIANGLE_DIRECT_CORRECT_RATE_MIN = 0.75;
const LOGIC_TRIANGLE_DIRECT_MIN_ATTEMPTED = 2;
